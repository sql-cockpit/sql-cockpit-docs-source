...
- Column: `CreatePrimaryKeyOnAutoCreate`
- Data type: bit
...
- Where it is read in code: `Sync-ConfiguredSqlTable.ps1:2617`
- Functional effect: Adds a PK on auto-created tables using configured key columns.
