...
- Where it is read in code: `Sync-ConfiguredSqlTable.ps1:2750`
- Functional effect: Controls whether incremental mode can start without existing checkpoint state.
