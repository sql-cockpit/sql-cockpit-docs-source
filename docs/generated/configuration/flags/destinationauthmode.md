...
- Column: `DestinationAuthMode`
- Data type: nvarchar
- Allowed values: `Integrated` for Windows auth; anything else resolves to SQL auth.
...
- Where it is read in code: `Sync-ConfiguredSqlTable.ps1:2439`, `Sync-ConfiguredSqlTable.ps1:2444`
