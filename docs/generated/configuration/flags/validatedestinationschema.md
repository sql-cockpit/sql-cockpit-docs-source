...
- Column: `ValidateDestinationSchema`
- Data type: bit
...
- Where it is read in code: `Sync-ConfiguredSqlTable.ps1:2624`
- Functional effect: Enables required-column validation before sync work.
