...
- Column: `AutoCreateDestinationTable`
- Data type: bit
...
- Where it is read in code: `Sync-ConfiguredSqlTable.ps1:2616`
- Functional effect: Allows the runtime to create a missing destination table from source metadata.
